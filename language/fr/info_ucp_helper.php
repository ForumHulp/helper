...
$lang = array_merge($lang, array(
		...
		'IMAGERESIZE_NOTICE'	=> '<div class="phpinfo"><p class="entry">Ce module est masqué et ne possède aucune option de configuration. Par ailleurs, merci configurer l’option sur la « Taille maximale d’un avatar » depuis le panneau d’administration.</p></div>',
